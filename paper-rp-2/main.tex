...
%\newcommand{\disTransc}{\tilde{\Tau}}
	...
	\input{paper-rp-2/intro.tex}
	
	%\section{Preliminaries}
	\input{paper-rp-2/rp.tex}
	...
	\input{paper-rp-2/boundedspace.tex}
	
	\section{A Composition Theorem for Rational Proofs}
	\input{paper-rp-2/composition.tex}
	
	
	%\section{Rational Proofs for Randomized Log-depth Circuits}
	\input{paper-rp-2/randomized.tex}
	
	\section{Sequential Composability}
	\label{sec:proofs-seq-comp}
	\input{paper-rp-2/seq-comp-defs}
	\input{paper-rp-2/proof-seq-comp.tex}
	
	
	
	\input{paper-rp-2/lowerbounds.tex}
