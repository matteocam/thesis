...
\begin{mylemma}[Advantage of a DFS prover]
\label{lem:DFS}
...
\begin{mylemma}[Advantage of a BFS prover]
\label{lem:BFS}
...
\begin{mylemma}[Advantage of a non adaptive prover]
\label{lem:gen-adv}
...
\begin{mylemma}[A bound for provers' advantage in regular circuits]
