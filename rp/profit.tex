...
As already pointed out in \cite{am1,rosen} the definition of Rational Proof is sufficiently robust to also maximize the {\sf profit} of the honest prover and not the reward. Indeed consider the case of a "lazy" prover $\disP$ that does not evaluate the function: even if 
